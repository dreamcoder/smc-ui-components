...
function buildThemeFile(theme, vars) {
    // Build less entry file: dist/smc.${theme}.less
    if (theme !== 'default') {
        fs.writeFileSync(
            path.join(process.cwd(), 'dist', `smc.${theme}.less`),
            `@import "../lib/style/${theme}.less";\n@import "../lib/style/components.less";`,
        );
        // eslint-disable-next-line no-console
        console.log(`Built a entry less file to dist/smc.${theme}.less`);
    } else {
        fs.writeFileSync(
...
function finalizeDist() {
    if (fs.existsSync(path.join(__dirname, './dist'))) {
        // Build less entry file: dist/smc.less
        fs.writeFileSync(
            path.join(process.cwd(), 'dist', 'smc.less'),
        ...
        // eslint-disable-next-line no-console
        console.log('Built a entry less file to dist/smc.less');
